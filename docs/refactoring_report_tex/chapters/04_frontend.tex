...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{figures/evidence/ui_02_dashboard.png}
  \caption{运营总览页面：任务统计、站点排行、系统时间和地图降级视图}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{figures/evidence/ui_03_stations.png}
  \caption{站点管理页面：统一搜索、导入、创建、列视图和表格布局}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{figures/evidence/ui_05_demand_prediction.png}
  \caption{需求预测页面：DLinear 模型 future 数据正常展示}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{figures/evidence/ui_06_settings_appearance.png}
  \caption{设置页面：主题、侧栏、页面布局和阅读方向已融入正式设置}
\end{figure}
